...
class ConsumerException(CommunicationException):
    """Base class of communication-consumer communicationModuleException"""
    pass
...
class ProducerException(CommunicationException):
    """Base class of communication-producer communicationModuleException"""
    pass
...
class NoSubscribeException(ConsumerException):
    """Raise when receive before subscribe"""
    def __init__(self):
        self.message = "Receive before subscribe"
